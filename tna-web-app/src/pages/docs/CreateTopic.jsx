...
class CreateTopic extends Component {
  ...
  onSubmit = values => {
    this.props.saveOrUpdateTopic("save", values, _ => this.props.history.goBack());
  };
  ...
  render() {
    const { classes, roles, subSections, location } = this.props;
      ...
      <div>
        <div className={classes.header}>
          <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />} aria-label="breadcrumb">
            ...
            <Typography color="textPrimary">Create Topic</Typography>
          </Breadcrumbs>
        </div>
